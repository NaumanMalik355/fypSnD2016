...
const rows = [
  ...
  <div>
    <EditIcon /><DeleteIcon style={{marginLeft:10}} /></div>),
...
const headRows = [
  ...
  { label: 'Store Name', numeric: true, disablePadding: false, id: 'Uet lahore' },
...
const useStyles = makeStyles(theme => ({
 ...
 function ShowDistributor(props) {
...
const [distributorList,setList]=React.useState([])
  ...
  useEffect(() => {
		alert("effect called")
    fetch('https://localhost:5001/api/Account/GetDistributors', {
			method: 'GET',
			headers: {
...
export default withRouter(ShowDistributor)